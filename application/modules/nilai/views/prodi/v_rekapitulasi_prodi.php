                    ...
                    <div class="box">
                        <div class="box-header">
                            <button onclick="window.print()" class="badge progress-bar-primary phide">
                                ...
                                <p align="left">
                            <a href="<?= base_url('Nilai/laporan_excel_prodi') ?>"  class="badge progress-bar-primary phide" > Export Excel </a>
                            </p>
                            ...
                            <center>
                                ...
                                <h3 class="box-title" id="judul">Semua Data Evaluasi Kinerja Dosen <br>
                                    <?= $user_prodi['nama_prodi']; ?> Universitas Malikussaleh</h3>
                                <img src="<?= base_url('assets/'); ?>img/logo1.png" class="user-image logo1"
                                    alt="User Image" 
                                    style="weight:40px; height:40px; margin-left: 600px; margin-top:-37px">
                            </center>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
